...
void euler::ProblemSelection() {
  ...
  problems["#4: Largest Palindrome Product"] = P_3;
  problems["#5: Smallest Multiple"] = P_3;
  problems["#6: Sum Square difference"] = P_3;
  problems["#7: 10001st Prime"] = P_3;
  ...
  for(std::map<std::string, void (*)()>::iterator it = problems.begin(); it != problems.end(); ++it){
